-- ============================================
-- SCRIPT SQL PARA MAIKPET - LIMPIO
...
(1, 'Luna', 'Perro', 24, 'Si', 'Golden retriever muy juguetona y cariñosa. Le encanta jugar con niños.', '18 de Julio 1234, Montevideo, Uruguay', -34.9011, -56.1645),
...
(2, 'Mia', 'Gato', 8, 'No', 'Gatita negra muy curiosa, busca hogar sin niños pequeños.', 'Av. Brasil 2890, Pocitos, Montevideo, Uruguay', -34.9171, -56.1540),
(3, 'Rocky', 'Perro', 48, 'Si', 'Bull terrier ingles, muy fiel y leal. Necesita dueño con experiencia.', 'Rivera 3142, Buceo, Montevideo, Uruguay', -34.8941, -56.1649),
...
-- VERIFICAR DATOS
-- ============================================
SELECT 'Usuarios creados:' AS mensaje, COUNT(*) AS cantidad FROM usuarios;
SELECT 'Mascotas creadas:' AS mensaje, COUNT(*) AS cantidad FROM mascotas;
