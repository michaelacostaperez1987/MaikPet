...
import com.example.pet.data.model.Usuario
...
data class MainUiState(
    ...
    val mascotas: List<com.example.pet.data.model.Mascota> = emptyList(),
    val misMascotas: List<com.example.pet.data.model.Mascota> = emptyList(),
    ...
    val selectedMascota: com.example.pet.data.model.Mascota? = null,
...
class MainViewModel @Inject constructor(
    ...
    fun editMascota(mascota: com.example.pet.data.model.Mascota) {
